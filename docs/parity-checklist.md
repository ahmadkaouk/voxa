# Voico Parity Checklist

This checklist tracks behavioral parity between legacy Voico and the current implementation.

Legacy behavior reference:
- `/Users/ahmadkaouk/projects/voico/README.md`
- `/Users/ahmadkaouk/projects/voico/docs/architecture.md`

Protocol reference:
- `/Users/ahmadkaouk/projects/voico/docs/ipc.md`
...
| ID | Behavior | Verification | Status |
|---|---|---|---|
| P-60 | Packaging/install story for daemon + menubar | release checklist needed | pending |
